...
<!DOCTYPE html>
    <html lang="en">
        <head>
            ...
            <title>Holiday Effects Manager Store</title>
            <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.8.1/css/all.css" integrity="sha384-50oBUHEmvpQ+1lW4y57PTFmhCaXp0ML5d60M1M7uH2+nqUivzIebhndOJK28anvf" crossorigin="anonymous">
            <link type="text/css" rel="stylesheet" href="//unpkg.com/bootstrap/dist/css/bootstrap.min.css"/>
            <link type="text/css" rel="stylesheet" href="//unpkg.com/bootstrap-vue@latest/dist/bootstrap-vue.css"/>
            <link rel="stylesheet" href="../admin/lib/vue-multiselect.min.css?v=1">
        ...
        <div id="manage-store">  
            <b-container >
                <h1>Manager App Holiday Effects</h1>
        ...
        <script src="../admin/lib/bootstrap-vue.js?v=1"></script>  
        <script type="text/javascript" src="../admin/lib/vue-multiselect.min.js?v=1"></script>
