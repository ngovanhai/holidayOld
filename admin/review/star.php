<div class="appRating col-xs-12">
    ...
    <link rel="stylesheet" href="admin/review/star.css?v=1">
    <div class="wp_rate" style="display:none;"> 
        <a href="#" class="rating-closebt close" onclick="hideDivRate()">×</a>
        <span>How would you rate app ?</span>
        <div id="rater"></div>  
    </div>
    <script src="admin/review/lib_star.js"></script>
    <script type="text/javascript">
            ...
            function sendReview() {
                ...
                $.ajax({
                    url: 'admin/review/sendComment.php',
                    type: 'GET',
                    data: data
                }).done((res) => {
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button onclick="hidenDiv()" aria-hidden="true" data-dismiss="modal" class="bootbox-close-button close" type="button">×</button>
    ...
    <div class="goodStar" style="display:none;">
        <div  role="dialog" onclick="hidenDiv()" id="moda_rating_good" tabindex="-1" class="bootbox modal fade in" style="display: block; padding-right: 15px;  background: #00000047;">
            <div class="modal-dialog" style="text-align: left;">
                <div class="modal-content">
                    <div class="modal-header">
                        <button aria-hidden="true" onclick="hidenDiv()" data-dismiss="modal" class="bootbox-close-button close" type="button">×</button>
